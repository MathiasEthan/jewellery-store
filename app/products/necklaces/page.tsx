...
const PRODUCTS_QUERY = defineQuery(`*[_type == "product" && type == "necklace" || category == "necklace"]{
  name, 
  price, 
  description,
...
export default async function Necklaces(){
  ...
  try {
    ...
    if (!products || products.length === 0) {
      return (
        <div className="container mx-auto py-8">
          ...
          <p className="text-center text-white">No necklaces found. Check back soon!</p>
        </div>
      )
    }
    ...
    return (
      <div className="container mx-auto py-8">
        <h1 className="text-3xl font-philosopher text-white mb-8 text-center">Necklaces</h1>
        <p className="text-center text-white">Sorry, we couldn't load the necklaces. Please try again later.</p>
      </div>
    )
  }
}