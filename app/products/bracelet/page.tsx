...
const PRODUCTS_QUERY = defineQuery(`*[_type == "product" && type == "bracelet" || category == "bracelet"]{
  name, 
  price, 
  description,
...
export default async function Bracelets(){
  ...
  try {
    ...
    if (!products || products.length === 0) {
      return (
        <div className="container mx-auto py-8">
          <h1 className="text-3xl font-philosopher text-white mb-8 text-center">Bracelets</h1>
          <p className="text-center text-white">No bracelets found. Check back soon!</p>
        </div>
      )
    }
    ...
    return (
      <div className="container mx-auto py-8">
        <h1 className="text-3xl font-philosopher text-white mb-8 text-center">Bracelets</h1>
        <p className="text-center text-white">Sorry, we couldn't load the bracelets. Please try again later.</p>
      </div>
    )
  }
}